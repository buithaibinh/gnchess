...
inline
void Board::MoveInfo::set(uint32 mv_, uint8 captured_, bool check_, uint32 key_)
{
	mv = mv_;
	captured = captured_;
	check = check_;
...
// class Engine : public tlib::ObjectBase
...
public:
	...
	static Glib::RefPtr<Engine> create();
	inline void init();
	// 装入开局库
	void load_book(void);
	// 搜索开局库
...
// typedef tlib::RefPtr<Engine> EnginePtr;
typedef Glib::RefPtr<Engine> EnginePtr;
